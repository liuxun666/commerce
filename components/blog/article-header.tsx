      ...
      <div className="relative mx-auto max-w-4xl px-4 py-8 sm:px-6 lg:px-8 lg:py-12">
        <div className="text-center space-y-8">
          ...
          <nav className="flex items-center justify-center space-x-2 text-sm text-secondary">
            ...
            {article.blog && (
              <>
                <a href={`/blogs/${article.blog.handle}`} className="hover:text-gray-400 transition-colors duration-200">
                  {article.blog.title}
                </a>
                <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 5l7 7-7 7" />
          ...
          {/* 标题 */}
          <h1 className="text-4xl font-blod tracking-tight text-primary sm:text-5xl lg:text-6xl leading-tight">
            {article.title}
          </h1>
          
          {/* 摘要 */}
          {article.excerpt && (
            <p className="mx-auto max-w-3xl text-lg leading-8 text-secondary">
              {article.excerpt}
            </p>
          )}
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-8 text-slate-500 dark:text-slate-400">
            ...
            {article.author && (
              <div className="flex items-center space-x-3">
                <div className="h-10 w-10 rounded-full bg-gradient-to-br from-slate-700 to-slate-600 flex items-center justify-center">
                  <svg className="h-5 w-5 ext-slate-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">

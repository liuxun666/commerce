...
export function ProductDetailDescription({ product }: { product: Product }) {
  ...
  return (
    <section className="max-w-7xl mx-auto px-4 py-12 card-interactive">
      ...
      <div className="space-y-8 animate-fade-in">
        ...
        {/* 描述内容区域 */}
        <div className="relative p-8 md:p-12 shadow-xl group animate-slide-up" style={{ animationDelay: '0.2s' }}>
          {/* 装饰性几何图形 */}
